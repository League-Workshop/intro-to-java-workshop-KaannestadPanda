...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("THA MAZE.jpg"));
	...
	public void mouseMoved(MouseEvent e) {
		...
		if((((mouseColor ==-6684927) || (mouseColor ==-327425) || (mouseColor ==-16446978) || (mouseColor ==-25343)))) {
			scare();
		}
	...
	if(mouseColor ==-65263) {
		JOptionPane.showMessageDialog(null, "YOU WIN N STUFF");
	}
